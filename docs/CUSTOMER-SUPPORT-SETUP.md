...
2026-09-25 헬쑤 앱 콘솔에 기존 Supabase 콜백을 유지하고 로컬(127.0.0.1:3000)·운영 고객센터 콜백을 등록했다. talk_message는 이용 중 동의로 저장했다. 운영 웹 도메인은 이미 등록되어 있다. 로컬 서버 client secret은 Git 제외 파일에 저장했다. 실제 계정 동의 및 연결 확인은 별도 수행한다.
