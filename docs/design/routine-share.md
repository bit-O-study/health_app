...
> 2026-08-11 · 상태: **설계(구현 전)** · 요청: `docs/requests/2026-08-11.md` (4)
...
| 단계 | 내용 | 이걸로 되는 것 |
|---|---|---|
| 1 | DDL + 스냅샷 만들기/읽기 순수 로직 + 단위테스트 | 공유 데이터가 생긴다 |
| 2 | 운동 탭 "이 일차 소개하기" 시트 | 내 루틴을 올릴 수 있다 |
| 3 | 커뮤니티 `루틴` 세그먼트 + 카드 + 부위 칩 | 남의 루틴이 보인다 |
| 4 | 상세 + "담기" + 일차 선택 시트 | 기능 완성 |
| 5 | 좋아요·신고·담긴 수 + E2E(올리기→담기→내 루틴 확인) | 운영 가능 |
