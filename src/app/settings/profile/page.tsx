  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10 sm:px-8">
      ...
      <div className="mt-6 mb-6 space-y-1">
        <h1 className="text-2xl font-bold text-zinc-950">체형 정보</h1>
        <p className="text-sm leading-6 text-zinc-600">
          키·몸무게·체지방률·근육량을 기록하면 추천 운동 강도가 맞춰지고,
          아래 그래프로 추이를 볼 수 있습니다.
        </p>
      </div>

      <div className="space-y-6">
        <section className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <h2 className="mb-3 text-base font-bold text-zinc-950">추이 그래프</h2>
          <BodyChart logs={logs} />
        </section>

        <section className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <h2 className="mb-1 text-base font-bold text-zinc-950">
            체형 기록
          </h2>
