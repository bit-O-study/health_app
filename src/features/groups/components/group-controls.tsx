    ...
    return (
      <div className="flex items-center gap-1.5">
        ...
        <button
          type="button"
          onClick={copyLink}
          className="inline-flex h-8 flex-1 items-center justify-center gap-1 rounded-lg border border-emerald-300 bg-emerald-50 text-xs font-bold text-emerald-700 transition hover:bg-emerald-100 dark:border-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300"
        >
          {copied ? (
