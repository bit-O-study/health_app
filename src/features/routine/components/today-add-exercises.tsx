...
export function TodayAddExercises() {
  ...
  return (
    <button
      ...
      onClick={go}
      disabled={pending}
      className="inline-flex h-9 items-center gap-1.5 rounded-md border app-field px-3 text-xs font-semibold text-zinc-700 transition hover:border-brand/40 hover:bg-brand-soft disabled:opacity-60 dark:text-zinc-300"
    >
      {pending ? (
