...
export const EXTRA_METHODS: Record<string, Partial<Record<EquipmentId, string[]>>> =
  ...
  "hammer-strength-high-row": {
    "machine": [
      "가슴 패드와 시트를 조절하고 양발을 바닥에 둔 채 위쪽 손잡이를 양손으로 잡는다",
      "가슴을 패드에 붙이고 팔꿈치를 아래·뒤로 보내 손잡이를 가슴 옆으로 당긴다",
      "몸통을 젖히지 않고 팔을 천천히 펴 시작 위치로 돌아온다"
    ]
  },
  "rack-pull": {
    "barbell": [
  ...
  "landmine-row": {
    "landmine": [
      "바벨 한쪽을 랜드마인 소켓에 고정하고 바를 양발 사이에 둔다. 앞 원판 뒤의 V그립을 양손으로 잡는다",
      "엉덩이를 뒤로 보내 상체를 숙이고 등을 중립으로 유지한 채 손잡이를 배 쪽으로 당긴다",
      "다리 반동 없이 팔을 천천히 펴며 바벨을 내린다"
    ]
  },
  ...
  "smith-machine-shoulder-press": {
    "smith": [
      "등받이를 세운 벤치에 앉고 양발을 바닥에 둔다. 얼굴 앞 높이의 바를 어깨보다 약간 넓게 잡는다",
      "등을 지지한 채 레일을 따라 바를 머리 위로 밀어 팔꿈치를 편다",
      "머리를 앞으로 내밀지 않고 팔꿈치가 약 90도로 굽혀질 때까지 천천히 내린다"
    ]
  },
  ...
  "machine-lateral-raise": {
    "machine": [
      "시트 높이를 조절해 패드를 팔꿈치 바깥쪽에 대고 등을 등받이에 붙인다",
      "발을 바닥에 두고 팔꿈치 각도를 유지한 채 양팔을 옆으로 어깨 높이까지 들어 올린다",
      "몸통을 흔들지 않고 패드를 지지하며 천천히 시작 위치로 내린다"
    ]
  },
  ...
  "face-pull-2": {
    "cable": [
      "도르래를 눈높이에 맞추고 로프 양끝을 잡는다. 뒤로 물러나 케이블에 장력을 만든다",
      "몸통을 세우고 로프를 얼굴 쪽으로 당기며 양손을 얼굴 양옆으로 벌린다",
      "팔꿈치를 뒤로 보낸 자세에서 천천히 팔을 펴 시작 위치로 돌아온다"
    ]
  },
  "barbell-upright-row": {
    "barbell": [
      "양발을 어깨너비로 두고 바벨을 오버핸드로 잡아 허벅지 앞에 둔다",
      "바를 몸 가까이 끌어올리며 팔꿈치를 옆으로 벌린다. 팔꿈치는 어깨 높이를 넘기지 않는다",
      "몸통을 젖히거나 반동을 쓰지 않고 바벨을 천천히 내린다"
    ]
  },
  "cable-upright-row": {
    "cable": [
      "낮은 도르래에 일자 바를 연결하고 손등이 위를 향하게 잡아 허벅지 앞에 둔다",
      "몸통을 세운 채 바를 몸 가까이 끌어올린다. 팔꿈치는 옆으로 벌리되 어깨 높이를 넘기지 않는다",
      "허리를 젖히거나 반동을 쓰지 않고 천천히 바를 내린다"
    ]
  },
  "landmine-press": {
    "landmine": [
      "바벨 한쪽 끝을 랜드마인 소켓에 고정하고 반대쪽 끝을 양손으로 감싸 윗가슴 앞에 둔다",
      "양발로 바닥을 지지하고 몸통을 세운 채 바벨을 앞·위로 밀어 팔꿈치를 편다",
      "허리를 젖히거나 무릎 반동을 쓰지 않고 같은 경로로 천천히 가슴 앞으로 내린다"
    ]
  },
  "plate-front-raise": {
    "plate": [
  ...
  "cable-glute-kickback": {
    "cable": [
      "낮은 도르래에 연결한 스트랩을 한쪽 발목에 고정하고 양손으로 머신을 지지한다",
      "지지 발과 몸통을 고정하고 무릎 각도를 유지한 채 작업 다리를 고관절에서 뒤로 보낸다",
      "허리를 젖히거나 골반을 돌리지 않고 천천히 다리를 시작 위치로 되돌린다"
    ]
  },
  "hip-abduction-machine": {
    "machine": [
      "등과 엉덩이를 시트에 붙이고 패드를 허벅지 바깥쪽에 맞춘다. 발은 발받침에, 손은 손잡이에 둔다",
      "무릎을 굽힌 상태로 몸통을 고정하고 양 허벅지를 바깥으로 벌려 패드를 민다",
      "반동 없이 천천히 다리를 모아 시작 자세로 돌아온다"
    ]
  },
  "hip-adduction-machine": {
    "machine": [
      "등을 등받이에 붙이고 허벅지 안쪽에 패드를 댄다. 발은 발받침에, 손은 손잡이에 둔다",
      "무릎을 굽힌 각도를 유지하고 허벅지를 모아 양쪽 패드를 안으로 민다",
      "몸통을 고정한 채 천천히 다리를 벌려 시작 위치로 돌아온다"
    ]
  },
  "leg-press-calf-raise": {
    "machine": [
      "등과 엉덩이를 시트에 붙이고 발볼을 발판 아래쪽 가장자리에 둬 뒤꿈치가 자유롭게 움직이게 한다",
      "손잡이를 잡고 무릎 각도를 유지한 채 발볼로 발판을 밀어 발목을 편다",
      "무릎을 과하게 펴거나 굽히지 않고 발목을 천천히 굽혀 종아리를 늘린다"
    ]
  },
  "curtsy-lunge-2": {
    "dumbbell": [
  ...
  "machine-preacher-curl": {
    "machine": [
      "시트를 조절해 상완 뒷면을 프리처 패드에 붙이고 양손으로 손바닥이 위를 향하게 손잡이를 잡는다",
      "상완을 패드에 고정하고 팔꿈치를 굽혀 손잡이를 어깨 쪽으로 당긴다",
      "몸통을 흔들지 않고 팔꿈치가 거의 펴질 때까지 천천히 내린다"
    ]
  },
  ...
  "lying-triceps-extension": {
    "barbell": [
      "평평한 벤치에 누워 머리·등·엉덩이를 지지하고 양발을 바닥에 둔다. 바벨을 어깨너비로 잡아 어깨 위로 든다",
      "위팔을 세운 위치에 유지하고 팔꿈치를 굽혀 바를 이마 위까지 천천히 내린다. 얼굴에 닿지 않게 멈춘다",
      "손목을 곧게 유지하고 팔꿈치를 펴 시작 위치로 돌아온다. 팔꿈치를 옆으로 벌리거나 가슴으로 바를 내리지 않는다"
    ]
  },
  "ez-bar-skull-crusher": {
    "barbell": [
      "평평한 벤치에 누워 머리·등·엉덩이를 지지하고 양발을 바닥에 둔다. EZ바의 굽은 손잡이를 어깨너비로 잡아 어깨 위로 든다",
      "위팔을 세운 위치에 유지하고 팔꿈치를 굽혀 EZ바를 이마 위까지 천천히 내린다. 얼굴에 닿지 않게 멈춘다",
      "손목을 곧게 유지하고 팔꿈치를 펴 시작 위치로 돌아온다. 팔꿈치를 옆으로 벌리거나 가슴으로 바를 내리지 않는다"
    ]
  },
  "dumbbell-overhead-extension": {
    "dumbbell": [
      "등받이 벤치에 곧게 앉아 양발을 바닥에 둔다. 덤벨 하나의 위쪽 원판 아래를 양손으로 받쳐 머리 위로 든다",
      "위팔을 귀 옆에 유지하고 팔꿈치를 굽혀 덤벨을 머리 뒤로 천천히 내린다. 목에 닿지 않게 하고 허리를 젖히지 않는다",
      "팔꿈치 위치를 유지하며 팔을 펴 덤벨을 머리 위로 올린다. 반동 없이 천천히 반복한다"
    ]
  },
  "triceps-pushdown-2": {
    "cable": [
  ...
  "reverse-wrist-curl": {
    "dumbbell": [
      "벤치에 앉아 손바닥이 아래를 향하게 덤벨을 잡고 전완을 허벅지에 지지한다. 손목은 무릎 앞에 둔다",
      "전완과 팔꿈치를 움직이지 않고 손등을 위로 들어 손목을 편다",
      "그립을 뒤집지 않은 채 손을 천천히 아래로 내려 시작 자세로 돌아온다"
    ]
  },
  "behind-the-back-wrist-curl": {
    "barbell": [
      "바벨을 엉덩이 뒤에서 양손으로 잡고 손바닥이 뒤를 향하게 한다. 팔을 편 채 몸통을 세운다",
      "팔꿈치와 어깨를 고정하고 손가락으로 바를 감싸 쥐며 손목을 굽혀 살짝 들어 올린다",
      "바를 놓치지 않도록 지지하며 손목과 손가락을 천천히 시작 위치로 되돌린다"
    ]
  },
  "farmer-s-carry": {
    "dumbbell": [
  ...
  "pallof-press-2": {
    "cable": [
      "가슴 높이 도르래 옆에 서서 양발을 어깨너비로 두고 손잡이를 양손으로 가슴 앞에 잡는다",
      "몸통과 골반이 돌아가지 않게 고정하고 손잡이를 가슴에서 정면으로 밀어 팔을 편다",
      "정면을 유지하며 손잡이를 천천히 가슴 앞으로 되돌린다"
    ]
  },
  "v-up-2": {
    "bodyweight": [
  ...
  "kettlebell-press": {
    "kettlebell": [
      "양발을 어깨너비로 두고 케틀벨을 어깨 앞 랙 자세로 잡는다. 손목을 곧게 유지한다",
      "무릎 반동 없이 케틀벨을 머리 위로 밀어 팔꿈치를 편다",
      "몸통을 세운 채 케틀벨을 천천히 어깨 앞 랙 자세로 되돌린다"
    ]
  },
  "kettlebell-windmill": {
    "kettlebell": [
  ...
  "kettlebell-deadlift": {
    "kettlebell": [
      "발 사이 바닥에 케틀벨을 두고 엉덩이를 뒤로 보내 무릎을 굽힌 뒤 손잡이를 양손으로 잡는다",
      "등을 중립으로 유지하고 팔을 편 채 고관절과 무릎을 펴며 곧게 일어선다",
      "케틀벨을 몸 가까이 유지하며 엉덩이를 뒤로 보내 바닥에 천천히 내려놓는다"
    ]
  },
  ...
  "band-biceps-curl": {
    "band": [
      "밴드 가운데를 양발로 밟고 양손에 손잡이를 잡는다. 손바닥은 앞쪽을 향하게 한다",
      "상완을 몸 옆에 고정하고 팔꿈치를 굽혀 손잡이를 어깨 쪽으로 당긴다",
      "몸통을 흔들지 않고 천천히 팔꿈치를 펴 시작 위치로 돌아온다"
    ]
  },
