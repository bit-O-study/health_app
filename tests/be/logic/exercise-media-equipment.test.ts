...
vi.mock("../../../public/exercise-guides/ai-v3/manifest.json", () => ({ default: ["dumbbell-shoulder-press", "rejected-guide"] }));
vi.mock("../../../tools/media/motion-guides/reviews.json", () => ({
  default: [{ id: "dumbbell-shoulder-press", status: "passed", equipmentIds: ["dumbbell"] }, { id: "rejected-guide", status: "rejected", equipmentIds: ["barbell"] }],
}));
