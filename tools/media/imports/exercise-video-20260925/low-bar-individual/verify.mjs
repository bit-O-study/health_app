...
const output=`tools/media/imports/exercise-video-20260925/low-bar-individual/playback-${id}.json`;
const media=readFileSync(`tools/media/imports/exercise-video-20260925/low-bar-individual/public/exercise-guides/ai-v3/${id}.mp4`);
