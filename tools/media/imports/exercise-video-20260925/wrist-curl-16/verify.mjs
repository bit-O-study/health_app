...
const id=process.argv[2]??'behind-the-back-wrist-curl';
if(!/^[a-z0-9-]+$/.test(id))throw Error('Expected an exercise video ID');
const output=`tools/media/imports/exercise-video-20260925/wrist-curl-16/playback-${id}.json`;
const media=readFileSync(`tools/media/imports/exercise-video-20260925/wrist-curl-16/public/exercise-guides/ai-v3/${id}.mp4`);
