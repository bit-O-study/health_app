...
try {
  ...
  writeFileSync('tools/media/imports/playback-20260916.json',JSON.stringify({checkedAt:new Date().toISOString(),scope:'Direct MP4 playback on mobile Chromium; not app layout or physical Android',results},null,2));
